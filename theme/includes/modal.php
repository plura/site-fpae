...
<button type="button" class="btn btn-warning" data-toggle="modal" data-target="#modal-contacts">
  <span class="icon"></span>
  <span class="text"><?php _e('Contact Request', _theme_name()); ?></span>
</button>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel"><?php _e('Contact Request', _theme_name()); ?></h4>
      ...
      <div class="modal-footer">
        ...
        <input type="submit" value="<?php _e('Submit', _theme_name()); ?>" class="btn btn-warning">
