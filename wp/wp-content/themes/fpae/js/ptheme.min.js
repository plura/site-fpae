 ...
 * 2015
 */
plura.obj("pTheme",function(a){var e=[],b=a.pwp,c=b.lang;a=a.process;var d=$("#modal-contacts");e.push(new ptheme.modules.Footer({pwp:b,process:a}));d.length&&e.push(new ptheme.modules.Quotes({lang:c,process:a,target:d}));new ptheme.layout.ResizeManager({objects:e});$("#qtranslate-chooser").addClass("dropdown-menu")});$(function(){new pTheme({process:PWP.template_dir+"process/process.php",pwp:PWP})});
